...
class Agent_Runner():
    def __init__(self,starting_agent_name, agents, session_state) -> None:
        ...
        self.evaluator = Agent(engine="gpt-35-turbo", persona="As a customer support manager, you need to assign call transfer requests to the right agent with the right skills. You have following agents with the description of their persona: \n\n"+evaluator_persona)
